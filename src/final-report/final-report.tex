...
\section{Results}
    ...
    \begin{table*}[t]
        \centering
        \caption{Table containing the final loss (MSE and L1) of testing and training after 50 epochs for bidirectional RNN.}
        \scalebox{1.25}{
            \begin{tabular}{lllll}
                \hline
                Dataset	&          MSE &   	&           L1 & 		\\
        ...
        \begin{table}[h!] \centering
            ...
            \begin{threeparttable}
                \scalebox{1.25}{
                    \begin{tabular}{lll}
                        \hline
                        Neural Network Name & A. Data 1 & A. Data 2\\
                        \hline
                        Traditional RNN &   0.001120 &      0.004046\\
                        Bidirectional RNN & 0.0013673 &     0.0030743\\
                        GRU &               0.000583076 &   \textbf{0.00137562}\\
                        LSTM &              \textbf{0.00010624} &    0.0018777\\
                        \hline
                    \end{tabular}
                }
            \end{threeparttable}
            ...
            \begin{threeparttable}
                \scalebox{1.25}{
                    \begin{tabular}{lll}
                        ...
                        Neural Network Name & A. Data 1 & A. Data 2\\
                        \hline
                        Traditional RNN &   0.035910 &      0.104709\\
                        Bidirectional RNN & 0.035822 &      0.0331284\\
                        GRU &               0.0248689 &   0.0331632\\
                        LSTM &              \textbf{0.005836} &    \textbf{0.0312243}\\
                        \hline
                    \end{tabular}
                }
            \end{threeparttable}
